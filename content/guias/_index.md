...
{{< hextra/feature-grid cols="2" >}}
    ...
    {{< hextra/feature-card link="que-no-hacer" title="¿Qué no debemos hacer?" icon="warning" >}}
    
    {{< hextra/feature-card link="faq" title="Preguntas frecuentes" icon="question-mark-circle" >}}
